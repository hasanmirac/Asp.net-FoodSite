<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanici.master" AutoEventWireup="true" CodeFile="KategoriDetayaspx.aspx.cs" Inherits="KategoriDetayaspx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <ItemTemplate>
        <table class="auto-style6">
            <tr>
                <td class="auto-style6" style="background-color:#8d9090"><strong><a href="YemekDetay.aspx?Yemekid=<%#Eval("Yemekid") %>">
                    <asp:Label ID="Label3"
